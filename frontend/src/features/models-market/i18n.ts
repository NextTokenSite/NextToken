...
const messages = {
  zh: {
    ...
    eyebrow: '公开模型 · 透明定价',
    unitNote: 'Token 价格单位为积分 / 1M Token；图片档位价格单位为积分 / 次，均已按渠道基础价 × 分组倍率计算。',
    ...
    'price.image': '图像输出',
    'price.perRequest': '按次',
    'price.unitToken': '积分 / 1M Token',
    'price.unitRequest': '积分 / 次',
    'empty.title': '暂无公开模型',
  ...
  en: {
    ...
    unitNote: 'Token prices are in credits per 1M tokens; image tier prices are in credits per request, all calculated as channel base × group rate multiplier.',
    ...
    'price.unitToken': 'Credits / 1M tokens',
    'price.unitRequest': 'Credits / request',
